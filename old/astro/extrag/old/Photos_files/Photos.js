...
{return IWCreatePhotocast("http://www.astro.sunysb.edu/jdonovan/test/Photos_files/rss.xml",true);}
function initializeMediaStream_id2()
{createMediaStream_id2().load('http://www.astro.sunysb.edu/jdonovan/test',function(imageStream)
